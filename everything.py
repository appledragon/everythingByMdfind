    ...
    def set_chinolor_light_mode(self):
        ...
        self.setStyleSheet("""
            ...
            QGroupBox {
                ...
                padding-top: 16px;
                font-weight: 600;
                background-color: rgba(212, 208, 200, 0.1);
            }
            QGroupBox::title {
                subcontrol-origin: margin;
                left: 12px;
            ...
            QPushButton:hover {
                background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 #2091c5, stop: 1 #1781b5);
                border-color: #2091c5;
            }
            QPushButton:pressed {
                background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 #145a8a, stop: 1 #0f4670);
            }
            QPushButton:disabled {
            ...
            QLineEdit {
                ...
                color: #2b312c;
                selection-background-color: #207f4c;
                font-size: 13px;
                min-height: 18px;
            }
            QLineEdit:focus {
                border: 2px solid #1781b5;
                background-color: #faf9f7;
            }
            QLineEdit:hover {
                border-color: #b4b0a8;
            ...
            QTreeWidget::item:hover {
                background-color: rgba(23, 129, 181, 0.1);
            }
            QTreeWidget::item:selected {
                background: qlineargradient(x1: 0, y1: 0, x2: 1, y2: 0,
                    stop: 0 #207f4c, stop: 1 #1a6b3f);
                color: white;
                border-radius: 3px;
            }
            QHeaderView::section {
                background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 #f5f4f2, stop: 1 #faf9f7);
                color: #c03e3e;
                border: none;
            ...
            QToolButton:hover {
                background-color: rgba(23, 129, 181, 0.2);
                border-color: #1781b5;
            }
            QToolButton:pressed {
            ...
            #previewCloseButton {
                background-color: rgba(192, 62, 62, 0.2);
                border: 1px solid #d4d0c8;
                border-radius: 4px;
                color: #2b312c;
                font-size: 14px;
            ...
            QTabBar::tab:hover {
                background: #e5e2da;
                border-top: 2px solid #2091c5;
            }
            QTabBar::tab:hover:selected {
                border-top: 2px solid #1781b5;
            }
            QTabBar QToolButton {
                background: rgba(23, 129, 181, 0.2);
                border: 1px solid #d4d0c8;
                border-radius: 4px;
                color: #2b312c;
                font-size: 16px;
            ...
            QTabBar QToolButton:hover {
                background: rgba(192, 62, 62, 0.3);
                color: #c03e3e;
                border: 1px solid #c03e3e;
            }
            QTabBar QToolButton:pressed {
                background: rgba(192, 62, 62, 0.4);
                color: #c03e3e;
            }
        """)
