...
* **빠른 접근 북마크:**
    ...
    * 압축 파일
    * 애플리케이션
* **디스크 공간 분석:** 모든 디렉토리의 디스크 공간 사용량 분석:
    * 원클릭 홈 디렉토리 공간 분석
    * 최상위 공간 소비 폴더를 보여주는 인터랙티브 막대 차트 시각화
    * 검색 결과의 모든 폴더를 우클릭하여 공간 사용량 분석
    * 차트 막대를 더블클릭하여 하위 디렉토리로 드릴다운하여 세부 분석
    * 색상별로 구분된 차트로 하위 디렉토리 크기 시각적 분석
    * 가장 큰 폴더를 식별하기 위한 자동 크기별 정렬
