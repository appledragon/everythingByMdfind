...
## Créer une application autonome (Optionnel)

Vous pouvez utiliser py2app pour créer une application macOS autonome :
...
3.  **Compiler l'application :**
    ...
    Le bundle d'application macOS sera situé dans le répertoire `dist`.
